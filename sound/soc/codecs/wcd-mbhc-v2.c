...
static void wcd_mbhc_set_and_turnoff_hph_padac(struct wcd_mbhc *mbhc)
{
	...
	* removal event to sync-up PA's state */
	...
	if (is_project(OPPO_15399)||is_project(OPPO_15109)) {
...
static void wcd_correct_swch_plug(struct work_struct *work)
{
    ...
    if (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022)||is_project(OPPO_15399)||is_project(OPPO_15109)) {
        //John.Xu@PhoneSw.AudioDriver, 2015/06/11, Add for Qcom patch for slow insert headset
            if (mbhc->btn_press_intr) {
                wcd_cancel_btn_work(mbhc);
                mbhc->btn_press_intr = false;
		...
		if (result2 == 1)
		{
			...
			if ((hph_count == 6) && ((is_project(OPPO_15011)) || (is_project(OPPO_15018)) || (is_project(OPPO_15022)) || (is_project(OPPO_15399)||is_project(OPPO_15109))))
			{
